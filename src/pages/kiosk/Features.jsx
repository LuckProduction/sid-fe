    ...
    <section className="relative flex h-full w-full">
      <div className="flex h-full w-full flex-[2] items-center justify-center pb-60">
        <div className="flex flex-col px-24">
          <Typography.Paragraph>Hai Mohamad Rafiq Daud</Typography.Paragraph>
      ...
      <div className="flex h-full w-full flex-[4] items-center justify-center bg-blue-500">
        <div className="grid max-w-xl grid-cols-2 gap-6">
          ...
          <button className="col-span-1 flex flex-col items-center justify-center gap-y-4 rounded-md bg-white p-16 text-orange-500 transition-all duration-300 hover:-translate-y-2">
            <UserOutlined className="text-6xl" />
            Lapor Penduduk
          </button>
          <button className="col-span-1 flex flex-col items-center justify-center gap-y-4 rounded-md bg-white p-16 text-blue-500 transition-all duration-300 hover:-translate-y-2">
