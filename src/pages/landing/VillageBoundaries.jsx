...
const VillageBoundaries = () => {
    ...
    const { execute: fetchVillageBoundaries, ...getAllVillageBoundaries } = useService(
        LandingService.getAllVillageBoundaries
    );
    ...
    const formatGeoJsonUrl = (url) => {
        ...
        const newPath = path.replace("batas_desa", "pemetaan");

        return `http://desa1.localhost:8000/geojson?filename=${newPath}`;
    };
    ...
    }, [villageBoundaries.administrative_file]);
        ...
        <>
            ...
            <section className="min-h-screen w-full bg-white">
                {Object.keys(villageBoundaries).length === 0 ? (
                    ...
                    <div className="mx-auto  max-w-screen-lg px-6 py-12 grid grid-cols-12 gap-4">
                        ...
                        <Card className="col-span-6">
                            <MapContainer center={[0.6930, 122.4704]} zoom={8} style={{ height: "500px", width: "100%" }}>
