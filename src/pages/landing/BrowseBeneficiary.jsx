  ...
  return (
    <section className="relative h-screen w-full bg-white">
      <div className="relative z-10 mx-auto flex h-full max-w-screen-sm flex-col items-center justify-center px-6 text-center">
        <Reveal>
          <Typography.Title>
            Cari Penerima <span className="text-blue-500">Bantuan</span>
          </Typography.Title>
        </Reveal>
        <Reveal>
          <div className="flex items-center justify-center">
            <small className="text-center">Temukan penerima bantuan dengan cepat! Masukkan data yang diperlukan untuk melihat daftar penerima bantuan secara real-time.</small>
          </div>
        </Reveal>
        <Card className="mt-12 w-full">
          <Form onFinish={handleBeneficiaryCheck} className="flex w-full flex-col items-start gap-x-2 gap-y-4 lg:flex-row">
            <Form.Item
            ...
            <Form.Item className="m-0">
              <Button loading={checkBeneficiary.isLoading} className="w-full" icon={<SearchOutlined />} size="large" color="primary" variant="solid" htmlType="submit">
                Cari
              </Button>
            </Form.Item>
          </Form>
