...
import { BookOutlined, GroupOutlined, PushpinOutlined, SearchOutlined, UserOutlined } from "@ant-design/icons";
import { Avatar, Card, Descriptions, Menu, Typography } from "antd";
                        ...
                        {activeMenu === 'data_diri' ? (
                            <Card className="w-full" title="Data diri penduduk">
                                <Descriptions column={1} bordered>
                                    ...
                                    <Descriptions.Item label="Status Kependudukan">
                            ...
                            <Card className="w-full" title="Alamat">
                                <Descriptions column={1} bordered>
                                    <Descriptions.Item label="Alamat Sesuai KK">
                                        {resident.address.address_kk}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Dusun">
                                        {resident.address.hamlet_id}
                                    </Descriptions.Item>
                                    ...
                                    <Descriptions.Item label="Alamat Terakhir">
                                        {resident.address.last_address}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Nomor Telepon">
                                        {resident.address.telp}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Email">
                                        {resident.address.email}
                                    </Descriptions.Item>
                                </Descriptions>
                            </Card>
                            ...
                            <Card className="w-full" title="Kelahiran">
                                <Descriptions column={1} bordered>
                                    <Descriptions.Item label="Tanggal Lahir">
                                        {resident.birth.birth_date}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Tempat Lahir">
                                        {resident.birth.birth_place}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Nomor Akta Kelahiran">
                                        {resident.birth.akta_kelahiran_number}
                                    </Descriptions.Item>
                                </Descriptions>
                            </Card>
                            ...
                            <Card className="w-full" title="Orang Tua">
                                <Descriptions column={1} bordered>
                                    <Descriptions.Item label="Nama Ayah">
                                        {resident.parents.father_name}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Nama Ibu">
                                        {resident.parents.mother_name}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="NIK Ayah">
                                        {resident.parents.father_nik}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="NIK Ibu">
                                        {resident.parents.mother_nik}
                                    </Descriptions.Item>
                                </Descriptions>
                            </Card>
                            ...
                            <Card className="w-full" title="Pekerjaan dan Pendidikan">
                                <Descriptions column={1} bordered>
                                    <Descriptions.Item label="Pendidikan Terakhir">
                                        {resident.education_career.education_kk}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Pekerjaan">
                                        {resident.education_career.career}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Pendidikan Sedang Ditempuh">
                                        {resident.education_career.education_in_progress}
                                    </Descriptions.Item>
                                </Descriptions>
                            </Card>
                        ) : (
