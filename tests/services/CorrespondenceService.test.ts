...
const BASE_ENDPOINT = BASE_URL + '/correspondence';
...
describe('CorrespondenceService', () => {
  ...
  it('getAll(): should be able to get all Correspondences', async () => {
    const { message, status, data } = await CorrespondenceService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await CorrespondenceService.getAll('invalid token');
  ...
  it('store(): should be able to store a Correspondence', async () => {
    const { message, status } = await CorrespondenceService.store(new Correspondence(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await CorrespondenceService.store(new Correspondence(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await CorrespondenceService.store({} as Correspondence, 'token');
  ...
  it('update(): should be able to update a Correspondence', async () => {
    const { message, status } = await CorrespondenceService.update(1, new Correspondence(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await CorrespondenceService.update(1, new Correspondence(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await CorrespondenceService.update(1, {} as Correspondence, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await CorrespondenceService.update(2, new Correspondence(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Correspondence', async () => {
    const { message, status } = await CorrespondenceService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await CorrespondenceService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await CorrespondenceService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Correspondences', async () => {
    const { message, status } = await CorrespondenceService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await CorrespondenceService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await CorrespondenceService.deleteBatch([2, 3], 'token');
