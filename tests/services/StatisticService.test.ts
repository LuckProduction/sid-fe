...
const BASE_ENDPOINT = BASE_URL + '/statistic';
...
describe('StatisticService', () => {
  ...
  it('getAll(): should be able to get all Statistics', async () => {
    const { message, status, data } = await StatisticService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await StatisticService.getAll('invalid token');
  ...
  it('store(): should be able to store a Statistic', async () => {
    const { message, status } = await StatisticService.store(new Statistic(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await StatisticService.store(new Statistic(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await StatisticService.store({} as Statistic, 'token');
  ...
  it('update(): should be able to update a Statistic', async () => {
    const { message, status } = await StatisticService.update(1, new Statistic(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await StatisticService.update(1, new Statistic(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await StatisticService.update(1, {} as Statistic, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await StatisticService.update(2, new Statistic(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Statistic', async () => {
    const { message, status } = await StatisticService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await StatisticService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await StatisticService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Statistics', async () => {
    const { message, status } = await StatisticService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await StatisticService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await StatisticService.deleteBatch([2, 3], 'token');
