...
const BASE_ENDPOINT = BASE_URL + '/letter-attribute';
...
describe('LetterAttributeService', () => {
  beforeAll(() => server.listen({ onUnhandledRequest: 'error' }));
  afterAll(() => server.close());

  it('getAll(): should be able to get all Letter Attributes', async () => {
    const { message, status, data } = await LetterAttributeService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await LetterAttributeService.getAll('invalid token');
  ...
  it('store(): should be able to store a Letter Attribute', async () => {
    const { message, status } = await LetterAttributeService.store(new LetterAttribute(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await LetterAttributeService.store(new LetterAttribute(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await LetterAttributeService.store({} as LetterAttribute, 'token');
  ...
  it('update(): should be able to update a Letter Attribute', async () => {
    const { message, status } = await LetterAttributeService.update(1, new LetterAttribute(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await LetterAttributeService.update(1, new LetterAttribute(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await LetterAttributeService.update(1, {} as LetterAttribute, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await LetterAttributeService.update(2, new LetterAttribute(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Letter Attribute', async () => {
    const { message, status } = await LetterAttributeService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await LetterAttributeService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await LetterAttributeService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Letter Attributes', async () => {
    const { message, status } = await LetterAttributeService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await LetterAttributeService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await LetterAttributeService.deleteBatch([2, 3], 'token');
