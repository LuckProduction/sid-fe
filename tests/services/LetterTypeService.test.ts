...
const BASE_ENDPOINT = BASE_URL + '/letter-type';
...
describe('LetterTypeService', () => {
  ...
  it('getAll(): should be able to get all Letter Types', async () => {
    const { message, status, data } = await LetterTypeService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await LetterTypeService.getAll('invalid token');
  ...
  it('store(): should be able to store a Letter Type', async () => {
    const { message, status } = await LetterTypeService.store(new LetterType(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await LetterTypeService.store(new LetterType(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await LetterTypeService.store({} as LetterType, 'token');
  ...
  it('update(): should be able to update a Letter Type', async () => {
    const { message, status } = await LetterTypeService.update(1, new LetterType(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await LetterTypeService.update(1, new LetterType(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await LetterTypeService.update(1, {} as LetterType, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await LetterTypeService.update(2, new LetterType(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Letter Type', async () => {
    const { message, status } = await LetterTypeService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await LetterTypeService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await LetterTypeService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Letter Types', async () => {
    const { message, status } = await LetterTypeService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await LetterTypeService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await LetterTypeService.deleteBatch([2, 3], 'token');
