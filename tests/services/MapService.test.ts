...
const BASE_ENDPOINT = BASE_URL + '/map';
...
describe('MapService', () => {
  ...
  it('getAll(): should be able to get all Maps', async () => {
    const { message, status, data } = await MapService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await MapService.getAll('invalid token');
  ...
  it('store(): should be able to store a Map', async () => {
    const { message, status } = await MapService.store(new Map(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await MapService.store(new Map(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await MapService.store({} as Map, 'token');
  ...
  it('update(): should be able to update a Map', async () => {
    const { message, status } = await MapService.update(1, new Map(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await MapService.update(1, new Map(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await MapService.update(1, {} as Map, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await MapService.update(2, new Map(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Map', async () => {
    const { message, status } = await MapService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await MapService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await MapService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Maps', async () => {
    const { message, status } = await MapService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await MapService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await MapService.deleteBatch([2, 3], 'token');
