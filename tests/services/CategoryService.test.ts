...
const BASE_ENDPOINT = BASE_URL + '/category';
...
describe('CategoryService', () => {
  ...
  it('getAll(): should be able to get all Categorys', async () => {
    const { message, status, data } = await CategoryService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await CategoryService.getAll('invalid token');
  ...
  it('store(): should be able to store a Category', async () => {
    const { message, status } = await CategoryService.store(new Category(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await CategoryService.store(new Category(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await CategoryService.store({} as Category, 'token');
  ...
  it('update(): should be able to update a Category', async () => {
    const { message, status } = await CategoryService.update(1, new Category(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await CategoryService.update(1, new Category(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await CategoryService.update(1, {} as Category, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await CategoryService.update(2, new Category(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Category', async () => {
    const { message, status } = await CategoryService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await CategoryService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await CategoryService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Categorys', async () => {
    const { message, status } = await CategoryService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await CategoryService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await CategoryService.deleteBatch([2, 3], 'token');
