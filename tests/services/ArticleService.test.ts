...
const BASE_ENDPOINT = BASE_URL + '/article';
...
describe('ArticleService', () => {
  ...
  it('getAll(): should be able to get all Articles', async () => {
    const { message, status, data } = await ArticleService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await ArticleService.getAll('invalid token');
  ...
  it('store(): should be able to store a Article', async () => {
    const { message, status } = await ArticleService.store(new Article(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await ArticleService.store(new Article(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await ArticleService.store({} as Article, 'token');
  ...
  it('update(): should be able to update a Article', async () => {
    const { message, status } = await ArticleService.update(1, new Article(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await ArticleService.update(1, new Article(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await ArticleService.update(1, {} as Article, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await ArticleService.update(2, new Article(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Article', async () => {
    const { message, status } = await ArticleService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await ArticleService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await ArticleService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Articles', async () => {
    const { message, status } = await ArticleService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await ArticleService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await ArticleService.deleteBatch([2, 3], 'token');
