...
const BASE_ENDPOINT = BASE_URL + '/visi-misi';
...
describe('VisiMisiService', () => {
  ...
  it('getAll(): should be able to get all Visi Misis', async () => {
    const { message, status, data } = await VisiMisiService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await VisiMisiService.getAll('invalid token');
  ...
  it('store(): should be able to store a Visi Misi', async () => {
    const { message, status } = await VisiMisiService.store(new VisiMisi(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await VisiMisiService.store(new VisiMisi(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await VisiMisiService.store({} as VisiMisi, 'token');
  ...
  it('update(): should be able to update a Visi Misi', async () => {
    const { message, status } = await VisiMisiService.update(1, new VisiMisi(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await VisiMisiService.update(1, new VisiMisi(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await VisiMisiService.update(1, {} as VisiMisi, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await VisiMisiService.update(2, new VisiMisi(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Visi Misi', async () => {
    const { message, status } = await VisiMisiService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await VisiMisiService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await VisiMisiService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Visi Misis', async () => {
    const { message, status } = await VisiMisiService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await VisiMisiService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await VisiMisiService.deleteBatch([2, 3], 'token');
