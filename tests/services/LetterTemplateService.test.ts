...
const BASE_ENDPOINT = BASE_URL + '/letter-template';
...
describe('LetterTemplateService', () => {
  ...
  it('getAll(): should be able to get all Letter Templates', async () => {
    const { message, status, data } = await LetterTemplateService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await LetterTemplateService.getAll('invalid token');
  ...
  it('store(): should be able to store a Letter Template', async () => {
    const { message, status } = await LetterTemplateService.store(new LetterTemplate(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await LetterTemplateService.store(new LetterTemplate(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await LetterTemplateService.store({} as LetterTemplate, 'token');
  ...
  it('update(): should be able to update a Letter Template', async () => {
    const { message, status } = await LetterTemplateService.update(1, new LetterTemplate(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await LetterTemplateService.update(1, new LetterTemplate(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await LetterTemplateService.update(1, {} as LetterTemplate, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await LetterTemplateService.update(2, new LetterTemplate(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Letter Template', async () => {
    const { message, status } = await LetterTemplateService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await LetterTemplateService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await LetterTemplateService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Letter Templates', async () => {
    const { message, status } = await LetterTemplateService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await LetterTemplateService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await LetterTemplateService.deleteBatch([2, 3], 'token');
