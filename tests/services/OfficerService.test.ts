...
const BASE_ENDPOINT = BASE_URL + '/officer';
...
describe('OfficerService', () => {
  ...
  it('getAll(): should be able to get all Officers', async () => {
    const { message, status, data } = await OfficerService.getAll('token');
  ...
  it('getAll(): should error when unauthorized', async () => {
    const { message, status, data } = await OfficerService.getAll('invalid token');
  ...
  it('store(): should be able to store a Officer', async () => {
    const { message, status } = await OfficerService.store(new Officer(3, 'Malik'), 'token');
  ...
  it('store(): should be error when unauthorized', async () => {
    const { message, status } = await OfficerService.store(new Officer(3, 'Malik'), 'invalid token');
  ...
  it('store(): should be error when bad request', async () => {
    const noName = await OfficerService.store({} as Officer, 'token');
  ...
  it('update(): should be able to update a Officer', async () => {
    const { message, status } = await OfficerService.update(1, new Officer(1, 'Rapik'), 'token');
  ...
  it('update(): should be error when unauthorized', async () => {
    const { message, status } = await OfficerService.update(1, new Officer(1, 'Rapik'), 'invalid token');
  ...
  it('update(): should be error when bad request', async () => {
    const noName = await OfficerService.update(1, {} as Officer, 'token');
    expect(noName.message).toBe('Bad request');
    expect(noName.status).toBe(false);
    expect(noName.errors).toStrictEqual({ name: ['The name field is required.'] });
  });
  ...
  it('update(): should be error when not found', async () => {
    const { message, status } = await OfficerService.update(2, new Officer(2, 'Rapik'), 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('delete(): should be able to delete a Officer', async () => {
    const { message, status } = await OfficerService.delete(1, 'token');
  ...
  it('delete(): should be error when unauthorized', async () => {
    const { message, status } = await OfficerService.delete(1, 'invalid token');
  ...
  it('delete(): should be error when not found', async () => {
    const { message, status } = await OfficerService.delete(2, 'token');

    expect(message).toBe('Not found');
    expect(status).toBe(false);
  });

  it('deleteBatch(): should be able to delete multiple Officers', async () => {
    const { message, status } = await OfficerService.deleteBatch([1, 2], 'token');
  ...
  it('deleteBatch(): should be error when unauthorized', async () => {
    const { message, status } = await OfficerService.deleteBatch([1, 2], 'invalid token');
  ...
  it('deleteBatch(): should be error when not found', async () => {
    const { message, status } = await OfficerService.deleteBatch([2, 3], 'token');
